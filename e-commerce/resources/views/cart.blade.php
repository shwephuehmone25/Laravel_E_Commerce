                ...
                <table class="table table-bordered text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        @foreach ($cartItems as $item)
                            <tr>
                                <td class="align-middle"><img src="{{ $item->attributes->image }}" alt=""
                                ...
                                <td class="align-middle">
                                    <form action="{{ route('cart.update') }}" method="POST">
                                        ...
                                        <input type="number" name="quantity" value="{{ $item->quantity }}"
                                            class="w-6 text-center bg-secondary" />
                                        <button type="submit"
                                            class="btn btn-primary btn-sm px-2 pb-2 ml-2 text-white">update</button>
                                    </form>
                                </td>
                ...
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-3 pt-1">
                            ...
                            <h6 class="font-weight-medium">${{ Cart::getTotal() }}</h6>
                        </div>
